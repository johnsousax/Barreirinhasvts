...
/** Silhueta de dunas derivada das formas do logotipo (laranja + azul). */
export function DuneDivider({ className = '', fill = '#ffffff' }: { className?: string; fill?: string }) {
  return (
    <svg viewBox="0 0 1440 120" preserveAspectRatio="none" className={className} aria-hidden>
      <path d="M0 70 C 220 20, 420 20, 640 62 S 1040 110, 1240 60 S 1400 30, 1440 40 V120 H0 Z" fill="#F59E1B" opacity=".9" />
      <path d="M0 86 C 260 50, 470 58, 700 82 S 1100 108, 1300 78 S 1420 66, 1440 70 V120 H0 Z" fill="#1486C9" opacity=".95" />
      <path d="M0 100 C 300 78, 520 90, 760 100 S 1180 116, 1440 92 V120 H0 Z" fill={fill} />
    </svg>
  );
}
